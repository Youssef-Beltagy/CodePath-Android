...
class ItemAdapter(private val listOfItems : List<String>, val clickListener: ItemEventListener) : RecyclerView.Adapter<ItemAdapter.ViewHolder>() {

    interface ItemEventListener{
        fun onItemDeleteRequest(position: Int)

        fun onItemEditRequest(position: Int)
    }
